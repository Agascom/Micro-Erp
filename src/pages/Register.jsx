            ...
            <div className="relative w-full max-w-md">
                ...
                <div className="backdrop-blur-xl bg-white/10 border border-white/20 rounded-3xl shadow-2xl p-8">
                    ...
                    <div className="text-center mb-8">
                        ...
                        <p className="text-white/60">Rejoignez Micro ERP dès maintenant</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                <span className="absolute left-4 top-1/2 -translate-y-1/2 text-white/40 material-symbols-outlined">person</span>
                                <input
                                    type="text"
                                    value={name}
                        ...
                        <div className="space-y-2">
                            <label className="block text-sm font-medium text-white/80">Confirmer le mot de passe</label>
                            <div className="relative">
                                <span className="absolute left-4 top-1/2 -translate-y-1/2 text-white/40 material-symbols-outlined">lock</span>
                                <input
                                    type="password"
